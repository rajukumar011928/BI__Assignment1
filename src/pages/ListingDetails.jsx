           ...
           <div className="row">
                <div className="col-md-7">
                    ...
                    <p><strong>{dataFetch?.hostedBy}</strong></p>
                     <div>
              <img src={dataFetch?.image} className="card-img-top img-fluid" alt="..."/>
               ...
               <div className="py-4 shadow p-3 mb-5 bg-body-tertiary rounded">
                 ...
                 <p className="card-text"><strong>Price:</strong> {dataFetch?.price}</p>
                   ...
                   <div className="mt-4 shadow p-3 mb-5 bg-body-tertiary rounded">
                    <div className="card-body">
                          <h4 className="card-text text-center mb-3">Speakers:</h4>
                          <div className="row g-3 justify-content-center">
                            {dataFetch?.speakers?.map((speaker) => (
                                <div className="col-md-4 col-sm-6" key={speaker._id}>
                                    <div className="card text-center p-3 h-100">
                                <img src={speaker?.image} className="rounded-circle mx-auto" width="80"height="80" alt="error"/>
