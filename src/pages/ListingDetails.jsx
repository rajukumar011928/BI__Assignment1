        ...
        <div className="container mt-4">
            ...
            <div className="col mt-4 ">
               <div className="py-4 shadow p-3 mb-5 bg-body-tertiary rounded">
                  <div className="card-body">
                 <p class="card-text">{dataFetch.date} at {dataFetch.startTime}</p>
                 <p class="card-text">TO</p>
                 <p class="card-text">{dataFetch.date} at {dataFetch.endTime}</p>
                 <p class="card-text"><strong>Location:</strong> {dataFetch.location}</p>
                 <p class="card-text"><strong>Price:</strong> {dataFetch.price}</p>
                 </div>
                 </div>
